...
#     REVISION:  02/17/2012 02:21:35 PM
#===============================================================================
...
if (@ARGV < 1) {
    ...
    GetOptions('help|?'             => sub { print "grepfasta.pl [--inverse|-v] [-p='search pattern'|-f=<file with search patterns>] fasta_file\n"; exit; },
               'man'                => sub { print "grepfasta.pl [--inverse|-v] [-p='search pattern'|-f=<file with search patterns>] fasta_file\n"; exit; },
               'v|inverse!'         => \$inverse,
...
#      VERSION:  03/11/2010 10:34:32 AM CET
...
#===  POD DOCUMENTATION  =======================================================
#      VERSION:  10/07/2011 01:59:43 PM
